...
ARQUIVO_FONTE_EM_TESTE = ARQUIVO_FONTE_COM_ERROS
...
try:
    ...
    subprocess.check_call(['python', 'analisadorSintatico.py' , ARQUIVO_FONTE_EM_TESTE,  ARQUIVO_SAIDA_LEXICO])
    print('Análise sintática foi conclída.')
    print('Análise de tipagem foi conclída.\n')

    print('Iniciando a geração de código intermediário\n...')
    subprocess.check_call(['python', 'geradorCodigoIntermediario.py' , ARQUIVO_FONTE_EM_TESTE,  ARQUIVO_SAIDA_LEXICO])
    print('Código intermediário foi gerado.')
